...
public class Services {
    ...
    private final UsageRepository usageRepo = new UsageRepository();
    ...
    public final UsageService usage = new UsageService(usageRepo);
    public final RatePlanService ratePlans = new RatePlanService(ratePlanRepo);
    public final ComparisonService comparison = new ComparisonService(usage, ratePlans);
